...
gfal-ls gsiftp://dtn02.nersc.gov/projecta/projectdirs/lz/spade/receiving/ukdc

N_OF_FILES=`gfal-ls gsiftp://dtn02.nersc.gov/projecta/projectdirs/lz/spade/receiving/ukdc | wc -l`
echo "There are ${N_OF_FILES} files in the receiving directory."
